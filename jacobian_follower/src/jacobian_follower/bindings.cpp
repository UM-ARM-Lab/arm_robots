...
PYBIND11_MODULE(pyjacobian_follower, m) {
  ...
  py::class_<JacobianFollower>(m, "JacobianFollower")
      ...
      .def("store_scene", &JacobianFollower::store_scene, py::arg("scene"))
      .def("plan_with_stored_scene", &JacobianFollower::plan_with_stored_scene, py::arg("group_name"),
           py::arg("tool_names"), py::arg("preferred_tool_orientations"), py::arg("start_state"), py::arg("grippers"),
