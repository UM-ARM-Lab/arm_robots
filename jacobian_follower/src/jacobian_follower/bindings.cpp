...
PYBIND11_MODULE(pyjacobian_follower, m) {
  py::class_<JacobianFollower>(m, "JacobianFollower")
      .def(py::init<std::string, double, bool>(), py::arg("robot_namespace"), py::arg("translation_step_size"),
           py::arg("minimize_rotation"))
      .def(
          "plan_from_start_state",
          py::overload_cast<std::string const &, std::vector<std::string> const &, std::vector<Eigen::Vector4d> const &,
                            moveit_msgs::RobotState const &, std::vector<std::vector<Eigen::Vector3d>> const &, double,
      ...
      .def(
          "plan",
          py::overload_cast<std::string const &, std::vector<std::string> const &, std::vector<Eigen::Vector4d> const &,
                            std::vector<std::vector<Eigen::Vector3d>> const &, double, double>(
              &JacobianFollower::plan_return_msg),
